...
/*****************************************************************************/
void setraw(uint8_t sockid, struct nl_sock *socknl, int argc, char **argv, rawdevs_t rawdevs[MAXRAWNB]) {
...
int main(int argc, char **argv) {
  ...
  rawdevs_t rawdevs[MAXRAWNB]; memset(&rawdevs,0,sizeof(rawdevs));
